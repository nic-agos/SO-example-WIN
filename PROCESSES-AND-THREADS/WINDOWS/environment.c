...
int main(int argc, char *argv[]) 
{
	...
	if (argc>1)
	{
		...
		newprocess = CreateProcess(argv[1],
			...
			(LPVOID)
			//"A=10\0B=20\0\0",
					NULL, // se imposto null sto dicendo che voglio che erediti le informazioni di ambiente dal padre
			//"MY_VARIABLE=34\0\0", // please try the various alternatives environments variable here
			NULL,
			&si,
			&pi);
